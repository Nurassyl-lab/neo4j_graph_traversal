...
parser.add_argument('--dimension_size', default=100, type=int)
args = parser.parse_args()

device = 'cuda' if torch.cuda.is_available() else 'cpu'
path = 'D://Dewen//ML//datasets//FB15k//'
...
writer = SummaryWriter(log_dir=f'runs/fb15k/{args.model}_{args.dimension_size}')
...
# Save the model
model_path = osp.join('models', f'fb15k/{args.model}_{args.dimension_size}_model.pth')
